...
const fallbackProducts: CatalogProduct[] = [
  { id: 'DUZ-001', code: 'DUZ-001', name: 'Soudal Pu Silikon Yapıştırıcı 300ml', brand: 'Soudal', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'DUZ-002', code: 'DUZ-002', name: 'Soudal Poliüretan Yapıştırıcı 750ml', brand: 'Soudal', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'DUZ-003', code: 'DUZ-003', name: 'Soudal Silikon Buji Beyaz 300ml', brand: 'Soudal', image: '/images/soudal-build-future.jpg' },
  { id: 'DUZ-004', code: 'DUZ-004', name: 'Soudal Akril Yapıştırıcı 500ml', brand: 'Soudal', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'DUZ-005', code: 'DUZ-005', name: 'Soudal Epoksi Hızlı 100ml', brand: 'Soudal', image: '/images/teknobond-401ep.jpg' },
  { id: 'DUZ-006', code: 'DUZ-006', name: 'Soudal Su Geçirmez İzolasyon 5L', brand: 'Soudal', image: '/images/soudal-build-future.jpg' },
  { id: 'DUZ-007', code: 'DUZ-007', name: 'Soudal Metal Bağlantı Spreyi 400ml', brand: 'Soudal', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'DUZ-008', code: 'DUZ-008', name: 'Soudal Termal Yalıtım Contası', brand: 'Soudal', image: '/images/soudal-build-future.jpg' },
  { id: 'DUZ-009', code: 'DUZ-009', name: 'Soudal Açık Hava Koruyucu 1L', brand: 'Soudal', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'DUZ-010', code: 'DUZ-010', name: 'Soudal Yüzey Temizleyici 500ml', brand: 'Soudal', image: '/images/teknobond-401ep.jpg' },
  { id: 'ACT-001', code: 'ACT-001', name: 'Aktix Yapı Silikon Beyaz 300ml', brand: 'Aktix', image: '/images/teknobond-401ep.jpg' },
  { id: 'ACT-002', code: 'ACT-002', name: 'Aktix Silikon Buji Şeffaf 300ml', brand: 'Aktix', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'ACT-003', code: 'ACT-003', name: 'Aktix Enerji Tasarruflu Pencere Buji', brand: 'Aktix', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'ACT-004', code: 'ACT-004', name: 'Aktix Yalıtım Bandı 50m', brand: 'Aktix', image: '/images/soudal-build-future.jpg' },
  { id: 'ACT-005', code: 'ACT-005', name: 'Aktix Yapı Sızdırmazlık 1L', brand: 'Aktix', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'APE-001', code: 'APE-001', name: 'Apel Montaj Aksesuar Seti', brand: 'Apel', image: '/images/beta-products.jpg' },
  { id: 'APE-002', code: 'APE-002', name: 'Apel Plastik Dolgu Malzemesi', brand: 'Apel', image: '/images/beta-products.jpg' },
  { id: 'APE-003', code: 'APE-003', name: 'Apel Montaj Camı Profili', brand: 'Apel', image: '/images/beta-products.jpg' },
  { id: 'SEL-001', code: 'SEL-001', name: 'Selsil Silikon Temizlik Ürünü 500ml', brand: 'Selsil', image: '/images/selsil-logo.jpg' },
  { id: 'SEL-002', code: 'SEL-002', name: 'Selsil Buji Temizleme Solüsyonu 1L', brand: 'Selsil', image: '/images/selsil-logo.jpg' },
  { id: 'TYT-001', code: 'TYT-001', name: 'Tytan Poliüretan Yapıştırıcı 750ml', brand: 'Tytan', image: '/images/tytan-logo.jpg' },
  { id: 'TYT-002', code: 'TYT-002', name: 'Tytan Silikon Buji Beyaz 300ml', brand: 'Tytan', image: '/images/tytan-mobilya.jpg' },
  { id: 'TYT-003', code: 'TYT-003', name: 'Tytan Yüzey Stabilizatörü 5L', brand: 'Tytan', image: '/images/tytan-mobilya.jpg' },
  { id: 'TEK-001', code: 'TEK-001', name: 'Tekno Koruyucu Kaplama 10L', brand: 'Tekno', image: '/images/teknobond-401ep.jpg' },
  { id: 'TEK-002', code: 'TEK-002', name: 'Tekno Endüstriyel Çıkmazlıklar 1L', brand: 'Tekno', image: '/images/teknobond-401ep.jpg' },
  { id: 'DUZ-011', code: 'DUZ-011', name: 'Soudal Profesyonel Tamir Harcı 1kg', brand: 'Soudal', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'DUZ-012', code: 'DUZ-012', name: 'Soudal Yüksek Performanslı Conta', brand: 'Soudal', image: '/images/soudal-build-future.jpg' },
  { id: 'DUZ-013', code: 'DUZ-013', name: 'Soudal Endüstriyel Yüzey Spreyi', brand: 'Soudal', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'DUZ-014', code: 'DUZ-014', name: 'Soudal İzolasyon ve Koruma Paketi', brand: 'Soudal', image: '/images/teknobond-401ep.jpg' },
  { id: 'DUZ-015', code: 'DUZ-015', name: 'Soudal Elastik Dolgu Harcı 600ml', brand: 'Soudal', image: '/images/soudal-build-future.jpg' },
  { id: 'SOU-SILICONE1', code: 'SOU-SILICONE1', name: '280 GR SOUDAL SILICONE U ŞEFFAF', brand: 'SOUDAL', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'SOU-SILICONE2', code: 'SOU-SILICONE2', name: '280 GR SOUDAL SILICONE U SİYAH', brand: 'SOUDAL', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'ACT-006', code: 'ACT-006', name: 'Aktix Cam Silikon Koyu 300ml', brand: 'Aktix', image: '/images/soudal-turkiye-satis.jpg' },
  { id: 'ACT-007', code: 'ACT-007', name: 'Aktix Poliüretan Dolgu 750ml', brand: 'Aktix', image: '/images/soudal-build-future.jpg' },
  { id: 'APE-004', code: 'APE-004', name: 'Apel Dil Profili Plastik 10m', brand: 'Apel', image: '/images/beta-products.jpg' },
  { id: 'APE-005', code: 'APE-005', name: 'Apel Kornişe Ek Parçası', brand: 'Apel', image: '/images/beta-products.jpg' },
  { id: 'SEL-003', code: 'SEL-003', name: 'Selsil Gözlük Temizlik Ürünü 200ml', brand: 'Selsil', image: '/images/selsil-logo.jpg' },
  { id: 'TYT-004', code: 'TYT-004', name: 'Tytan Silikon Buji Şeffaf 300ml', brand: 'Tytan', image: '/images/tytan-mobilya.jpg' },
  { id: 'TYT-005', code: 'TYT-005', name: 'Tytan Yapı Silikon Koyu 300ml', brand: 'Tytan', image: '/images/tytan-logo.jpg' },
  { id: 'TEK-003', code: 'TEK-003', name: 'Tekno Temizleyici Solüsyon 5L', brand: 'Tekno', image: '/images/teknobond-401ep.jpg' },
  { id: 'TEK-004', code: 'TEK-004', name: 'Tekno İzolasyon Bandı 50m', brand: 'Tekno', image: '/images/teknobond-401ep.jpg' },
]
