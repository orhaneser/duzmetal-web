...
function App() {
  ...
  if (currentPage === 'catalog') {
    return <ProductCatalogPage onNavigate={handlePageChange} />
  }
  ...
  if (currentPage === 'brands') {
    return <BrandsPage onNavigate={handlePageChange} />
  }

  if (currentPage === 'dealer') {
    return <DealerApplicationPage onNavigate={handlePageChange} />
  }
